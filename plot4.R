...
par(mfrow=c(2,2))
plot(hhpwrcon$newtime,as.numeric(as.character(hhpwrcon$Global_active_power)),type="l", xlab="",ylab="Global Active Power")
plot(hhpwrcon$newtime,as.numeric(as.character(hhpwrcon$Voltage)),type="l", xlab="datetime",ylab="Voltage")
...
plot(hhpwrcon$newtime,as.numeric(as.character(hhpwrcon$Global_reactive_power)),type="l", xlab="datetime",ylab="Global_reactive_power")
dev.off()
